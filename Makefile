...
#    Updated: 2023/09/26 19:20:43 by rennacir         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES			= main.c $(addprefix sources/, what_direction.c draw.c horz_vert_inter.c ray_angle.c dda.c map.c player.c raycasting.c normalize_angle.c render_3d.c) $(LIBFT) $(PARSING) $(GNL)
