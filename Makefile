...
#    Updated: 2023/09/27 16:08:38 by mouaammo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES			= main.c $(addprefix sources/, textures_data.c what_direction.c draw.c horz_vert_inter.c ray_angle.c dda.c map.c player.c raycasting.c normalize_angle.c render_3d.c) $(LIBFT) $(PARSING) $(GNL)
