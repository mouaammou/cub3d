...
#    Updated: 2023/09/26 17:02:19 by rennacir         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES			= main.c $(addprefix sources/, dda.c map.c player.c raycasting.c normalize_angle.c render_3d.c) $(LIBFT) $(PARSING) $(GNL)
